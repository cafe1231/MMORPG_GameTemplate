...
COMMENT ON COLUMN sessions.token_hash IS 'SHA256 hash of the refresh token';
COMMENT ON FUNCTION cleanup_expired_sessions() IS 'Removes expired sessions, should be called periodically via cron';
